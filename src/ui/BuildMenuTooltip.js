...
const ROOM_SUMMARIES = {
  ...
  mimic_vault:          'Looks like a Treasury. Spawns 2 Mimics disguised as chests (insta-kill on loot) + 1 Cursed Chest (-25% gold if a thief escapes alive).',
...
const ITEM_SUMMARIES = {
  ...
  treasure_chest_1:     'T1. Base 10g/day (scales w/ boss lv). Adventurers may steal 10% (10% tempted).',
  treasure_chest_2:     'T2. Base 20g/day (scales w/ boss lv). Adventurers may steal 17% (14% tempted).',
  treasure_chest_3:     'T3. Base 35g/day (scales w/ boss lv). Adventurers may steal 24% (19% tempted).',
  treasure_chest_4:     'T4. Base 55g/day (scales w/ boss lv). Adventurers may steal 31% (23% tempted).',
  treasure_chest_5:     'T5. Base 80g/day (scales w/ boss lv). Adventurers may steal 38% (28% tempted).',
  treasure_chest_6:     'T6. Base 110g/day (scales w/ boss lv). Adventurers may steal 45% (32% tempted).',
  treasure_chest_7:     'T7. Base 145g/day (scales w/ boss lv). Adventurers may steal 52% (37% tempted).',
  treasure_chest_8:     'T8. Base 185g/day (scales w/ boss lv). Adventurers may steal 59% (41% tempted).',
  treasure_chest_9:     'T9. Base 230g/day (scales w/ boss lv). Adventurers may steal 66% (46% tempted).',
  treasure_chest_10:    'T10. Base 300g/day (scales w/ boss lv). Adventurers may steal 75% (50% tempted).',
}
