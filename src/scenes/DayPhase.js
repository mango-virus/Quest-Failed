  ...
  _spawnChampionRaid(response) {
    ...
    if (champDef) {
      ...
      if (cSpawn) {
        ...
        const champSprite = { all_stars: 'champion_garreth', reckoning_dead: 'champion_necrarch', plunderers: 'champion_vane', inquisition: 'champion_mordrake', mage_tower: 'champion_velloran' }[response.id]
