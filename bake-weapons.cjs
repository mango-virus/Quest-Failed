...
const ATK_CLASSES = new Set([
  ...
  // KR Kingdom-Response champions — Sir Garreth (All-Stars / Longsword) + Necrarch
  // (Reckoning / Scythe) both swing slash_oversize, so the atk sheet is required for
  // a visible blade.
  'champion_garreth', 'champion_necrarch',
]);
